...
(function () {
  ...
  function normPost(p) {
    var d = toDate(pick(p, ["createdAt", "date", "createdDate", "writtenAt", "updatedAt"], null));
    ...
    return {
      ...
      category: pick(p, ["category", "boardType", "tag", "type", "patchType"], ""),
      author: pick(p, ["authorName", "author", "nickname", "writer", "userName"], "운영팀"),
  ...
  var API = {
    ...
    banners: function (page) {
      return memo("banners", function () {
        return fetchFirst(COLL.banners);
      }).then(function (rows) {
          ...
          return snap.docs
            .map(function (d) {
              ...
              return {
                ...
                photo: pick(o, ["authorPhoto", "photoURL"], ""),
